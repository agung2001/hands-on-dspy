...
import handson_dspy.wikipedia as wikipedia
...
def main():
    ...
    parser.add_argument("--wikipedia",action="store_true",help="Run wikipedia task")

    # Argument string
    parser.add_argument("--context", type=str, default="", help="Context for the task")
    parser.add_argument("--model", type=str, default="qwen3:4b", help="Language for the task")
